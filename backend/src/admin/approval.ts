...
export async function approveRequest(requestId: string) {
  ...
  // решение одобрить/отклонить, не пересылка ссылки — но если SMTP не
  // настроен, честно возвращаем delivered: false, а не притворяемся, что
  // отправили. Ошибка самой отправки (SMTP недоступен, неверные креды и
  // т.п.) не должна откатывать уже сохранённое одобрение — клиент и ссылка
