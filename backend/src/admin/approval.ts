...
export async function approveRequest(requestId: string) {
  ...
  // Доставка клиенту автоматическая (решение сессии 2026-09-03, раздел 2
  // спецификации) — контакт теперь всегда email (см. db/schema.ts), отдельный
  // выбор канала убран за ненадобностью. Ручным должно остаться только
