...
// Разбор визуальной айдентики по референсам рилса — чтобы промпт к видео
// опирался на стиль реальных фотографий клиента, а не сочинял его с нуля.
// Своей кнопки в кабинете у агента нет, обычно его запускает сам
// reels-video-generator; этот эндпоинт остаётся для ручного прогона. Модель
// здесь дороже осознанно: на вход идут личные фотографии
