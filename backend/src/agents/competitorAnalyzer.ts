...
const PROMPT_PATH = promptPath("competitor-analyzer.md");
...
// В Telegram публично видны только просмотры. Во ВКонтакте есть ещё лайки и
// репосты, и они весят больше: просмотр пассивен, а репост — осознанное
// действие, по нему лучше видно, что у аудитории действительно откликнулось.
