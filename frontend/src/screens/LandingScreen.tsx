      ...
      <section className="landing-section landing-split landing-cta" ref={formSectionRef}>
        <div className="landing-split-head reveal">
          ...
          <p className="landing-demo-note">
            ...
            метода — плюс план публикаций и готовый пост с картинкой на каждую вашу площадку, а для
            ВК ещё две-три идеи рилсов, один развёрнутый сценарий и видео по нему. Пока работаем
            только с Telegram и ВК.
          </p>
        </div>
