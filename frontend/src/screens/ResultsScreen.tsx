...
// Витрина готового демо, а не рабочий экран кабинета, и оформлена
// соответственно: ближе по тону к лендингу — теплее, с асимметрией, — чем к
// кабинету, где важнее скорость и ясность. Ссылку пересылают людям, которые
// продукт вообще не видели, поэтому страница должна продавать сама себя.
