  ...
  return (
    <div className="image-generation-block">
      ...
      <div className="image-generation-actions">
        ...
        {/* Повторной генерации здесь нет: клип стоит примерно в двадцать раз
            дороже картинки, и кнопка «заново» слишком легко превращается в
            несколько лишних списаний. У картинок она оставлена. */}
        {!video && (
